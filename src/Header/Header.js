...
function Header(props) {
    ...
    async function check_user_login_in_one_device_or_not() {
        if (gettingUserDetails[0]) {
            ...
            let result = await fetch(`${props.BaseUrl}/check_user_login_in_one_device_or_not/${gettingUserDetails[0].MobileNumber}/${gettingUserDetails[0].login_token}`, {
                method: "POST",
